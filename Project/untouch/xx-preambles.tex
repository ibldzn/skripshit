...
% \titleformat{\subsubsection}{\fontsize{14}{16}\bfseries}{\makebox[3.4em][l]{\thesubsubsection}}{0cm}{}
...
\setcitestyle{authoryear,round,aysep={,},notesep={: },semicolon}
...
% Counter kumulatif untuk tabel dan gambar ber-caption
\newcounter{totaltable}
\regtotcounter{totaltable}

\newcounter{totalfigure}
\regtotcounter{totalfigure}
...
\AtBeginDocument{%
	\pretocmd{\caption}{%
		...
		\else
			\ifdefstring{\@captype}{table}{\stepcounter{totaltable}}{}%
			\ifdefstring{\@captype}{figure}{\stepcounter{totalfigure}}{}%
		\fi
	}{}{}%
}
\makeatother

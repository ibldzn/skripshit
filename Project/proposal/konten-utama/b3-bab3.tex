...
\begin{sectioncontent}
    \hspace{\parindent}Analisa kebutuhan dilakukan untuk menentukan kebutuhan data, model, perangkat keras, dan perangkat lunak yang digunakan dalam penelitian. Kebutuhan tersebut disusun agar proses pelatihan, pengujian, dan analisis hasil dapat berjalan sesuai dengan tujuan penelitian.

    \subsection{Kebutuhan Data}
    \begin{subsectioncontent}
        \hspace{\parindent}Data yang dibutuhkan dalam penelitian ini adalah citra daun tomat yang telah dikelompokkan berdasarkan kelas penyakit dan kelas daun sehat. Dataset perlu memiliki struktur data latih, data validasi, dan data uji agar dapat digunakan pada proses pelatihan, validasi, dan evaluasi model klasifikasi.
...
\begin{subsectioncontent}
    ...
    Pada tahap pengujian inferensi menggunakan model ONNX, preprocessing dilakukan secara manual melalui script benchmark yang dijalankan pada perangkat \textit{edge}. Citra dibaca dalam format RGB, diubah ukurannya menjadi 224 x 224 piksel, dinormalisasi ke rentang nilai 0 sampai 1, kemudian diubah dari format HWC menjadi CHW dan ditambahkan dimensi batch. Tahapan tersebut dilakukan agar bentuk input sesuai dengan kebutuhan model YOLO versi klasifikasi dalam format ONNX.
\end{subsectioncontent}
...
\begin{subsectioncontent}
    ...
    \noindent\textbf{Pengujian Klasifikasi.}
    ...
    \noindent\textbf{Pengujian pada Perangkat \textit{Edge}.}

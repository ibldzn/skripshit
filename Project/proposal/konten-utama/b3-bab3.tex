...
\begin{sectioncontent}
    ...
    Karena penelitian ini mengikuti pembagian dataset awal, parameter \textit{random seed} tidak digunakan untuk proses pembagian data. Dengan demikian, aspek yang dijaga dalam penelitian ini adalah penggunaan dataset, struktur data, dan konfigurasi pelatihan yang sama untuk YOLOv8 Nano dan YOLO11 Nano.

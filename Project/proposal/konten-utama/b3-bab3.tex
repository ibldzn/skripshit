...
\begin{sectioncontent}
    ...
    Penelitian ini tidak menentukan seed untuk pembagian dataset karena struktur train, val, dan test telah tersedia dari dataset awal. Pada proses pelatihan, konfigurasi mengikuti parameter default Ultralytics yang tercatat pada file konfigurasi hasil training.

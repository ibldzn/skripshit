...
\begin{subsectioncontent}
    ...
    \begin{enumerate}[leftmargin=0.75cm,label=\arabic*.]
        \item Bagaimana performa YOLOv8 Nano dan YOLO11 Nano dalam melakukan klasifikasi penyakit daun tomat?

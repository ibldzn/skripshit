...
Dengan memanjatkan puji syukur ke hadirat Allah SWT yang telah melimpahkan segala rahmat dan hidayah-Nya kepada Penulis, sehingga tersusunlah Skripsi yang berjudul "\textbf{\judulid}"

Skripsi ini merupakan salah satu persyaratan yang diajukan dalam rangka menempuh ujian akhir untuk memperoleh gelar {\gelar} {\gelarsingkat} pada Program Studi {\prodi} di {\fakultas} {\universitas}.
...
\begin{enumerate}[leftmargin=0.5cm]
    ...
    \item Ibu \textbf{\kaprodi}, sebagai Koordinator Program Studi Teknik Informatika Universitas Bani Saleh, yang banyak membantu penulis dalam mengarahkan penulisan skripsi.
    \item Bapak \textbf{\pembimbingutama}, sebagai Pembimbing utama Skripsi dan dosen yang dengan sabar dan tekun memberikan arahan perbaikan yang berarti bagi penulis.
    \item Bapak \textbf{\pembimbingpendamping}, sebagai Pembimbing pendamping Skripsi dan dosen yang telah membagi ilmu pengetahuan dan pengalaman serta membimbing materi skripsi ini.
    \item Kedua orang tua penulis, Ayahanda \textbf{Dahyal Afkar} dan Ibunda \textbf{Syarifah Dzulhikmah Habib}, yang telah memberikan dukungan, doa, dan kasih sayang yang tiada henti kepada penulis selama ini.

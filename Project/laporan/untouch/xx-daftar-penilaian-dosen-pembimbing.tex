%==================================================================
% Ini adalah lembar daftar penilaian dosen pembimbing
%==================================================================

%% DILARANG EDIT BAGIAN INI
\newpage
\addcontentsline{toc}{chapter}{LEMBAR DAFTAR PENILAIAN \MakeUppercase{{\tipelaporan} DOSEN PEMBIMBING}}
\begin{center}
...
\begin{center}
    \begin{tabularx}{\textwidth}{|
        ...
        \rule{0pt}{3ex}
        \centering 2 &
        \centering Sistematika Penulisan &&
        &&
        \centering 40\% &
        \\ \hline
